...
function wired_packs() {	# this function intalls the needed deps for wiredWM
	sudo apt-get install nitrogen xterm arandr feh volumeicon-alsa flameshot pasystray kitty stterm surf conky suckless-tools lxpolkit vim nnn cmus xscreensaver -y
}
