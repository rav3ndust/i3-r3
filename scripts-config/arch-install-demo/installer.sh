...
function wired_packs() {	# this function intalls the needed deps for wiredWM
	sudo pacman -S git nitrogen arandr fish flameshot alacritty micro dunst amfora kitty feh code network-manager-applet conky vim sddm nnn picom chromium nemo
}
